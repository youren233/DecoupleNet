from lib.config.bcnet_config import CfgNode as CN
...
# Path (possibly with schema like catalog:// or detectr://) to a checkpoint file
...
_C.INPUT.MAX_SIZE_TRAIN = 1000 #1333
# Size of the smallest side of the image during testing. Set to zero to disable resize in testing.
_C.INPUT.MIN_SIZE_TEST = 600 #800
# Maximum size of the side of the image during testing
_C.INPUT.MAX_SIZE_TEST = 1000 #1333
...
_C.INPUT.MASK_FORMAT = "polygon" #"bitmask" #"polygon"  # alternative: "bitmask"
...
_C.MODEL.ROI_MASK_HEAD.CLS_AGNOSTIC_MASK = True #False
# Type of pooling operation applied to the incoming feature map for each RoI
...
# See detectr/solver/build.py for LR scheduler options
...
# and access it with:
#
# from detectr.config import global_cfg
