...
class TaskDecomposition(nn.Module):
    ...
    def forward(self, feat, avg_feat=None):
        ...
        conv_weight = weight.reshape(b, 1, self.stacked_convs, 1) * self.reduction_conv.conv\
            .weight.reshape(1, self.feat_channels, self.stacked_convs, self.feat_channels)
        ...
        Returns:
            tuple: Usually a tuple of classification scores and bbox prediction
                ...
                bbox_preds (list[Tensor]): Box energies / deltas for all scale
                    ...
                    num_anchors * 4.
        """
        # 获取 特征大小 和 anchor list
        num_imgs = len(feats[0])    # B
