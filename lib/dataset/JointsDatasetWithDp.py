...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # depth info
        depth_file = os.path.join(os.path.dirname(image_file) + "_depth", filename[:-4]+'-depth.png')
        ...
        depth_numpy = cv2.imread(
            depth_file, cv2.IMREAD_COLOR | cv2.IMREAD_IGNORE_ORIENTATION
        )
        ...
        # multi depth
        data_numpy = np.concatenate((data_numpy, depth_numpy), 2)
