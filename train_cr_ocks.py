...
from lib.core.train import train_dcp_cr_ocks
from lib.core.validate import validate_dcp_cr
...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        default='experiments/crowdpose/hrnet/w32_256x192-dcp-cr.yaml',
                        type=str)
...
def main():
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        train_dcp_cr_ocks(cfg, train_loader, model, criterion, ref_criterion, optimizer, writer_dict)
        lr_scheduler.step()
